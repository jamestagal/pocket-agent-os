"""
PocketFlow - Minimalist LLM Framework (~100 lines)
Vendored from: https://github.com/The-Pocket/PocketFlow
License: MIT

This is a readable, well-documented version of PocketFlow that maintains
full API compatibility with the original implementation.

Core Concepts:
- Node: Executes tasks through prep → exec → post lifecycle
- Flow: Orchestrates nodes via action-based transitions
- Shared Store: Python dictionary for inter-node communication
- Batch: Process multiple items (sequential or parallel)
